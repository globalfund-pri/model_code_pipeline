...
"""Extracts resource need data for malaria from PF 100 and GP scenarios.
...
class DatabaseChecksMalaria(MALARIAMixin):
    """Provides database functionality for malaria resource need extraction.

    This class combines malaria-specific functionality from MALARIAMixin to enable
    extraction of resource need data from the database.

    Attributes:
        Inherited from MALARIAMixin, including disease_name property.
    """
